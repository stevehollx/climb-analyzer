...
# Runs a command on every file in a specified folder

# ./compress-srtm30m.sh -v -p '*.hgt.zip' -c 'gdal_translate -co COMPRESS=DEFLATE -co PREDICTOR=2 {hgtzip_filename} {tif_filename}'
